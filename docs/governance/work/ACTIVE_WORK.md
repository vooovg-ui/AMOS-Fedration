...
| WI-038 | tooling-gates | T0 (‏قابليّةُ القياسِ · `DISC-046`: «الحالةُ المقيسةُ الآن» تُعلِنُ حجمَ حزمةٍ متقادمًا — المكتوبُ 1748 والمقيسُ 2351 — ولا بوّابةَ تقرأُ رقمًا في نثرٍ · **استحقاق 2026-09-10**) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | RESERVED | tools/governance/suite_size_inventory.py · tests/governance/test_w120_suite_size_claims.py | 2026-09-03 | 2026-09-10 | — | تنفيذُ الحرسِ ثمَّ تصحيحُ الرقمِ بقياسٍ طازجٍ | — |
...
العائق: —
الخطوةُ التالية: تنفيذُ الأداةِ والحرسِ، ثمَّ تصحيحُ الرقمِ بقياسٍ طازجٍ
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
...
قيدُ السجلّ: W-120 (‏الحجزُ) · و**خليّةُ «قيدُ السجلّ» في صفِّ § 1 تُكتَبُ `—`** بالسابقةِ المقيسةِ (`DISC-010` · `DISC-030`)
```
