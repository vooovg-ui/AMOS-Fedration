...
## تاريخ آخر تعديل: 2026-09-11 (`W-156` — حكمُ CI على عقدةِ `W-155` قُرِئَ أخضرَ 14/14 بالعدِّ الثلاثيِّ وقُيِّدَ برقمِه ورابطِه · واثنانِ وعشرونَ حجزًا جُدِّدَت إلى 2026-09-30 بنصِّ § 6.3 **في الصفِّ والكتلةِ معًا وبسببٍ مكتوبٍ** — ونطاقُ التجديدِ عينُ المجموعةِ التي تقرؤها `check_work_governance.py:483` (`RESERVED`/`IN_PROGRESS`/`IN_REVIEW`) وبنودُ `READY` لم تُمَسَّ · والجولةُ الرابعةُ من المراجعةِ المعزولةِ تُشغَّلُ على عقدةِ `W-156`)
...
| WI-051 | governance-docs | T2 | Driving H | مجلس المراجعة (GPT 5.6 + Grok 4.6) — والشقُّ `C3` (`decisions`) يحسمُه المالك | IN_REVIEW | docs/audit/SOVEREIGN_DECISION_REGISTER.md · docs/governance/work/THE_ROADMAP.md · docs/governance/work/OWNERSHIP.md · docs/governance/work/ACTIVE_WORK.md · docs/governance/work/RISK_REGISTER.md · docs/governance/work/DISCOVERIES.md · .github/workflows/ci.yml · PROJECT_STATE.md · docs/PROJECT_HANDBOOK.md · tests/governance/test_w150_gate_enforcement_in_ci.py · tests/governance/test_w154_reviewer_consistency.py | 2026-09-08 | 2026-09-30 | — (‏فُضَّ قفلُ `WI-023` بقرارِ المالكِ `Q-44`). والباقي **حكمُ المجلسِ**: الجولتانِ الأولى والثانيةُ رُفِضَتا بإجماعٍ، والثالثةُ انقسمَت (‏المراجعُ ب `VERIFIED` · المراجعُ أ `REJECTED` بعيبٍ `P1`)، فعُولِجَ اتّحادُ عيوبِها في `W-154` · **وجُدِّدَ الحجزُ إلى 2026-09-30 بنصِّ § 6.3** — والسببُ مكتوبٌ لا مطويٌّ: البندُ لم يُسلَّمْ ولم يُشغَّلْ له مراجعٌ بعدُ، والتجديدُ **رفعُ حاجزٍ زمنيٍّ** لا إنجازٌ ولا مراجعةٌ | الجولةُ الرابعةُ من المراجعةِ المعزولةِ **تُشغَّلُ الآنَ على عقدةِ `W-156`** — حاويتانِ منفصلتانِ ونسختانِ مستقلّتانِ من المستودعِ وبيئتانِ افتراضيّتانِ، وتكليفٌ أعمى لكلٍّ منهما (‏لا يرى أحدُهما تقريرَ الآخرِ ولا حاويتَه ولا شجرةَ عملِ المؤلِّفِ) بنموذجَي `GPT 5.6 Sol` و`Grok 4.6` بقرارِ المالكِ `Q-43`. **والجولةُ السابقةُ توقَّفَت لنفادِ رصيدِ النماذجِ وتُقيَّدُ كما وقعت لا تُمحى**. فإن أجمعَ المراجعانِ `VERIFIED` ⇒ `IN_REVIEW → VERIFIED` **بيدِ المراجعِ لا بيدِ المؤلِّفِ** (§ 4.3) ثمَّ `VERIFIED → CLOSED` في التزامٍ منفصلٍ بعدَ قراءةِ حكمِ CI على عقدةِ الاعتمادِ؛ وإن رفضَ أحدُهما ⇒ `IN_REVIEW → IN_PROGRESS` وإصلاحُ **اتّحادِ** العيوبِ ثمَّ جولةٌ خامسةٌ | — (يُكتتَبُ عندَ الإغلاقِ · § 7). وحكمُ CI الأحدثُ مقروءٌ ومُقيَّدٌ برقمِه ورابطِه في كتلةِ البندِ في § 3 |
