...
الدليلُ المطلوب:
  python -m pytest tests/governance/test_w110_commit_stamp_integrity.py -q
...
حكمُ CI المقروءُ (‏الأحدثُ): عقدةُ `1e800dd` · تشغيلٌ **69** (`33614088205`) · **failure · 11/13**
...
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
  ...
  - **ولا حرسَ على الطابعِ قبلَ كتابتِه**: القياسُ **بَعديٌّ**، يكشفُ النموَّ في الدفعةِ التاليةِ ولا يمنعُ التزامًا مغلوطًا لحظةَ إنشائِه
قيدُ السجلّ: W-110 · الحجزُ والعملُ في عقدةٍ واحدةٍ («الدفعُ = العملُ وقيدُه معًا»)
