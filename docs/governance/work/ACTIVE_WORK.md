...
| WI-020 | governance-docs | T0 / T2 (قرارٌ سياديٌّ يُقيَّدُ · وواجبُ § 7 يُوفَّى بعدَه) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | VERIFIED | docs/governance/work/THE_ROADMAP.md · tools/governance/check_work_governance.py · PROJECT_STATE.md · docs/PROJECT_HANDBOOK.md · tests/governance/test_w054_post_merge_reverse_link.py | 2026-08-30 | 2026-09-06 | — | مُراجَعٌ: معاييرُه السبعةُ تحقَّقَت ومنها `--enforce-post-merge` ⇒ 0 · ويُغلَقُ في الدفعةِ التاليةِ (§ 4.3 لا يُجيزُ الوثبَ) بحكمِ CI على عقدةِ `W-067` | — (يُكتَبُ عندَ الإغلاقِ · § 4.3) |
...
العائق: —
الخطوةُ التالية: يُقرأُ حكمُ CI على عقدةِ دفعِ `W-067` بالأداةِ المحروسةِ، ويُقيَّدُ رقمُه ورابطُه، ثمَّ يُنقَلُ هذا البندُ إلى `CLOSED` — § 7 واجب 2 و6
حدُّ البندِ — مُعلَنٌ لا مطويّ:
