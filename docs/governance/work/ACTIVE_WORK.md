...
| WI-047 | tooling-gates | T0 (‏قابليّةُ القياسِ · `DISC-055`: بوّابةٌ تطبعُ «ملاحظة ·» بعددٍ مقيسٍ ثمَّ تخرجُ برمزِ **0** — فالدَّينُ يُعَدُّ ولا يُرتَّجُ، وقد صعِدَ جردُ `UNWIRED_TOOL_INVENTORY` **20 ← 21** بينَ `W-130` و`W-131` بلا بوّابةٍ تُسمّيه · والمقيسُ **18 ملاحظةً عادّةً · صفرٌ محبوسةٌ · 18 بلا سقفٍ** · **استحقاق 2026-09-13**) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tools/governance/report_note_ratchet.py · tests/governance/test_w132_report_note_ratchet.py | 2026-09-03 | 2026-09-13 | لا عائقَ — المسارانِ **جديدانِ غيرُ مُدَّعيَينِ** فلا `CLAIM_COLLISION` (§ 6.2)، والبوّاباتُ الستُّ المقروءةُ **لا تُمَسُّ** (‏قراءةٌ تركيبيّةٌ لا كتابةٌ) | إنزالُ الحرسِ وفحوصِه، ثمَّ قراءةُ حكمِ CI برقمِ تشغيلٍ وقيدُه قبلَ النقلِ إلى `IN_REVIEW` (§ 4.3) | — |
