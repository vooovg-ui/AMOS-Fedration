...
| WI-045 | tooling-gates | T0 (‏قابليّةُ القياسِ · `DISC-053`: السطرُ الناجحُ لوجهِ `--check` يُعلِنُ حكمًا **كلّيًّا** ولا يقولُ **كم قرأَ**، فلا يُميَّزُ «قِيسَ ألفٌ» من «قِيسَ صفرٌ» — والمقيسُ **20** جملةً كلّيّةً منها **17** بلا مقامٍ · **استحقاق 2026-09-11**) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tools/governance/green_denominator_closure.py · tests/governance/test_w130_green_denominator_closure.py | 2026-09-03 | 2026-09-11 | لا عائقَ — المسارانِ **جديدانِ غيرُ مُدَّعيَينِ** فلا `CLAIM_CONFLICT` · والسبعَ عشرةَ جملةً لا يُرفَقُ بها مقامٌ في هذا البندِ: أكثرُ ملفّاتِها مُدَّعًى لبنودٍ في يدِ المراجعِ | قراءةُ حكمِ CI على عقدةِ الدفعِ ثمَّ النقلُ إلى `IN_REVIEW` بلا `VERIFIED` (§ 4.3) | — |
