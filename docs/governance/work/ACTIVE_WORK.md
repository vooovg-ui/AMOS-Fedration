...
| WI-028 | tooling-gates | T0 (قابليّةُ القياسِ · حرسٌ يقرأُ الدعوى بجذرِ كلمةٍ فيُحمِّرُ على قيدٍ صادقٍ) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tools/governance/mutation_claims.py · tests/governance/test_w063_registered_claims.py | 2026-09-01 | 2026-09-08 | — | قراءةُ حكمِ CI برقمِ تشغيلٍ ثمَّ نقلُ البندِ إلى `IN_REVIEW` | W-093 |
...
بدأ: 2026-09-01        ينتهي الحجز: 2026-09-08
العائق: —
الخطوةُ التالية: قراءةُ حكمِ CI برقمِ تشغيلٍ ثمَّ نقلُ البندِ إلى `IN_REVIEW` — والمراجعةُ للمالكِ (§ 4.3)
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
...
قيدُ السجلّ: W-092 · الحجزُ وفحصُ التداخلِ ⟶ W-093 · التنفيذُ والقياسُ ⟶ W-094 · حكمُ CI قُرِئَ فلَحِقَ الرقمُ المُعلَنُ بالمقيسِ (‏المِسبارُ 31/31)
```
