...
| WI-029 | tests-root | T0 (قابليّةُ القياسِ · فحصٌ يُشغِّلُ أداةً في عمليّةٍ فرعيّةٍ ويحكُمُ على شجرةٍ **لا يقرؤها** · `DISC-032`) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tests/governance/test_w096_subprocess_measurement_site.py · tests/governance/test_w054_post_merge_reverse_link.py | 2026-09-01 | 2026-09-08 | — | قراءةُ حكمِ CI على عقدةِ `W-097` برقمِ تشغيلٍ ثمَّ النقلُ إلى `IN_REVIEW` | — |
