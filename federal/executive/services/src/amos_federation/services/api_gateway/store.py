...
class InMemoryTaskStore:
    ...
    T3.6-DURABILITY: DOUBLE_NOT_WIRED — قِيسَ في W-029 أنَّ `api_gateway/main.py`
    يُوصِلُ `DatabaseTaskStore()` وحدَه، ولا نداءَ لهذا الصنفِ في شِفرةِ الإنتاج.
    فمخالفةُ `IN_MEMORY_STORE` المسجَّلةُ على هذا السطرِ تُشيرُ إلى **اسمٍ** لا إلى
    مخزنٍ موصولٍ — وبابُ ذلك العدّادِ Q-38.
    """
