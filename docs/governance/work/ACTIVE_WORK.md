...
| WI-039 | tooling-gates | T0 (‏قابليّةُ القياسِ · `DISC-021`: مُصنِّفُ مِرساةِ المساءلةِ يقرأُ **مسارًا مذكورًا في نثرٍ** حرسًا قائمًا، فمن كتبَ «لا حرسَ وهذانِ الملفّانِ لا يقيسانِ هذا» نالَ خُضرةً كاذبةً · **استحقاق 2026-09-11**) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | RESERVED | tools/governance/open_record_accountability.py · tests/governance/test_w124_anchor_declaration.py | 2026-09-03 | 2026-09-11 | — | جعلُ المِرساةِ إعلانًا مُهيكَلًا يُقرأُ، ثمَّ قياسُ ما بقيَ نثرًا وسقّاطتُه | — |
...
المسارات:
  ...
  tests/governance/test_w124_anchor_declaration.py                 (‏جديدٌ — يُثبِتُ أنَّ نثرًا نافيًا لا يُشترى به أخضرُ)
...
معيار القبول:
  1. مسارٌ لا يقعُ في **إعلانٍ مُهيكَلٍ للحرسِ** لا يُقرأُ مِرساةً — ولو وُجِدَ الملفُّ في الشجرةِ
...
الدليل المطلوب:
  ...
  python -m pytest tests/governance/test_w124_anchor_declaration.py -q
  python -m pytest tests/ -q
بدأ: 2026-09-03        ينتهي الحجز: 2026-09-11
العائق: —
الخطوةُ التالية: كتابةُ الإعلانِ المُهيكَلِ في الأداةِ وحرسِه، ثمَّ قياسُ الباقي وسقّاطتُه
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
