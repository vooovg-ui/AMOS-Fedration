...
## كيف تقرأ هذا السجل التاريخي

1. هذا الملف **سجل تاريخي مؤرشف** لمرحلة التصميم والتأسيس الأولى (P0–P9).
2. **الخارطة الحاكمة الحية لتنظيم العمل وحجز النطاقات:** [`docs/governance/work/THE_ROADMAP.md`](docs/governance/work/THE_ROADMAP.md) و[`docs/governance/work/ACTIVE_WORK.md`](docs/governance/work/ACTIVE_WORK.md).
3. **خريطة عصر التنفيذ وإثبات القدرات (E0–E24):** [`docs/audit/PHASE_E_ROADMAP.md`](docs/audit/PHASE_E_ROADMAP.md).
4. **الحقيقة المقاسة آليًّا:** [`docs/audit/TRUTH_MATRIX.md`](docs/audit/TRUTH_MATRIX.md) و[`docs/audit/COMPLETION_LEDGER.md`](docs/audit/COMPLETION_LEDGER.md).

## مفتاح الحالات التاريخية في هذا الملف

| الحالة في هذا الملف | المعنى التاريخي | المقابل في تعريف الإنجاز (DoD) |
|---|---|---|
| DONE | صُمِّم وأُنشئ هيكله المبدئي | `DESIGNED` / `SKELETON_COMMITTED` (لا يعني ثبوت القدرة) |
| DOING | كان قيد التصميم عند التجميد | `IN_PROGRESS` |
| NEXT / TODO | لم يكن قد صُمِّم بعد | `UNPROVEN` / `NOT_STARTED` |

---

## التقدم الأولي التاريخي (عند تجميد الخطة في 2026-08-16)

| المجال | المنجز تاريخيًّا | الإجمالي | الحالة التاريخية | حالة الإثبات المقاسة الحالية (DoD) |
|---|---:|---:|---|---|
| المراحل (P0–P9) | 9 | 9 | DESIGNED (هيكل أولي) | حلت محلها مراحل التنفيذ E0–E24 |
| المجالات المغطاة | 12 | 12 | SKELETON_COMMITTED | **0 من 12 إقليمًا PROVEN** (انظر `TRUTH_MATRIX.md`) |
| النوى المنشأة | 105 | 105 | SKELETON_COMMITTED | خاضعة لقانون الهوية وبطاقات الأقاليم |
| جداول قاعدة البيانات | 23 | 23 | DESIGNED | 85+ جدولاً مقاسًا في PostgreSQL |
| اختبارات الدخان | 12 | 12 | COMMITTED | 12 نطاقًا خضراء في CI |
| تغطية الاختبارات | 80% | 87.8% | MEASURED | محروسة ببوابة التغطية في CI |
| السجلات (Registries) | 12 | 12 | SKELETON_COMMITTED | محكومة بملكية النطاقات `OWNERSHIP.md` |
