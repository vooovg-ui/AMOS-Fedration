...
بدأ: 2026-08-31        ينتهي الحجز: 2026-09-08
العائق: —
الخطوةُ التالية: قراءةُ حكمِ CI على عقدةِ `W-084` برقمِ تشغيلٍ، ثمَّ تسليمُ البندِ للمراجعةِ — ولا يُنقَلُ إلى `VERIFIED` بيدِ صاحبِ التغييرِ (§ 4.3)
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
...
قيدُ السجلّ: W-084 · المفتاحُ نُقِلَ وأُعيدَ توليدُ القياسِ · 11 فحصًا خضراءَ (‏وقبلَه W-083 · الحجزُ وفحصُ التداخلِ)
```
