...
المسارات:
  ...
  tests/governance/test_w124_anchor_declaration.py                 (‏نزلَ في `W-125` — 21 فحصًا: قراءةُ الإعلانِ · السقّاطةُ · رفضٌ مُصنَّفٌ · طفرةٌ · المستودعُ الحقيقيُّ)
...
الدليل المطلوب (‏قِيسَ في `W-125` · 2026-09-03):
  python tools/governance/open_record_accountability.py                        # خروجٌ 0 · 68 صفًّا · 50 مفتوحًا · 29 محروسًا
  python tools/governance/open_record_accountability.py --declaration-check    # خروجٌ 0 · مُعلَنٌ حرسُها 4 · مسارٌ في نثرٍ 25 = السقّاطةُ 25
  python -m pytest tests/governance/test_w124_anchor_declaration.py -q         # 21 نجحَت
  python -m pytest tests/ -q                                                   # 2389 نجحَت · 1 مُتخطّاة · 0 فشل
...
الخطوةُ التالية: ترقيةُ صفوفٍ من الخمسةِ والعشرينَ إلى إعلانٍ مُهيكَلٍ (‏خفضُ السقّاطةِ) · ثمَّ قلبُ التصنيفِ متى تحرَّرَ حرسُ الأداةِ
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
