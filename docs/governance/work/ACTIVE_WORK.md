...
| WI-019 | tooling-gates | T0 (قابليّةُ القياسِ · حكمُ CI يُقرأُ ثمَّ يُخضَّرُ من سببِه) | Driving H | المجلس التأسيسي | IN_REVIEW | tools/crown/secret_scan_exceptions.py · tests/crown/test_w064_secret_scan_exceptions.py · tools/crown/verify_secret_boundaries.py · tests/sovereignty/test_outbox.py · docs/security/SECRET_BOUNDARIES.md · conftest.py · tests/governance/test_w064_services_src_fallback.py · .github/workflows/ci.yml | 2026-08-29 | 2026-09-06 | — | بعدَ الدمجِ يُنقَلُ إلى `CLOSED` بقيدِ `W-064` ورقمِ الدمجِ — إن فُتِحَ طريقُ الإغلاقِ بقرارِ `A-2` | — (يُكتَبُ بعدَ الدمج) |
