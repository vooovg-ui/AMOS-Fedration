...
| WI-037 | tooling-gates | T0 (‏قابليّةُ القياسِ · `DISC-042`: خليّةُ المساراتِ تُشطَرُ على «·» فيُقرأُ الجزءُ النثريُّ دعوى، ونثرٌ يذكرُ مجلَّدًا يُغطّيه كلَّه · **استحقاق 2026-09-09**) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | RESERVED | tools/governance/check_work_governance.py · tests/governance/test_w117_claim_cell_shape.py | 2026-09-03 | 2026-09-10 | — | تنفيذُ تشديدِ قراءةِ الخليّةِ ثمَّ `IN_PROGRESS`، ثمَّ قراءةُ حكمِ CI لعقدتِه | — |
...
المالك: Driving H            المراجع: المالك (`A-2` · غيرُ مستقلٍّ)
الحالة: RESERVED     (‏سُجِّلَ قبلَ مسِّ ملفٍّ · § 2 قاعدة 1)
المسارات:
...
العائق: —
الخطوةُ التالية: تنفيذُ التشديدِ ثمَّ `IN_PROGRESS`
