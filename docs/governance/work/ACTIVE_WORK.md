...
---
| WI-021 | tooling-gates | T0 / T0.4ب (إرجاعُ `main` أخضرَ · واحديّةُ الماسحِ ومحلُّ القياسِ الصريحُ) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_REVIEW | .github/workflows/ci.yml · tools/crown/verify_secret_boundaries.py · tools/governance/check_work_governance.py · tests/governance/test_w054_post_merge_reverse_link.py · tests/governance/test_w069_single_scanner_and_explicit_root.py · tests/governance/test_w069_status_contradiction.py · tests/governance/test_work_governance_gate.py · PROJECT_STATE.md · docs/PROJECT_HANDBOOK.md | 2026-08-30 | 2026-09-06 | — | يُقرأُ حكمُ CI على عقدةِ الدفعِ، ثمَّ `VERIFIED` فـ`CLOSED` في دفعةٍ تاليةٍ — § 4.3 لا يُجيزُ الوثبَ | — |
...
بدأ: 2026-08-30        ينتهي الحجز: 2026-09-06
العائق: —
الخطوةُ التالية: يُقرأُ حكمُ CI ثمَّ يُنقَلُ إلى `VERIFIED` فـ`CLOSED` في دفعةٍ تاليةٍ — § 4.3 لا يُجيزُ الوثبَ من `IN_REVIEW`
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
