...
| WI-023 | tooling-gates | T0 / T0.4ب (قابليّةُ القياسِ — دعوى «يُشغَّلُ في كلِّ دفعةٍ» تُقاسُ قبلَ أن تُقبَلَ سندًا) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tools/governance/guard_enforcement_closure.py · tests/governance/test_w077_guard_enforcement_closure.py · .github/workflows/ci.yml · PROJECT_STATE.md · docs/PROJECT_HANDBOOK.md · وسجلّاتٌ مُعفاةٌ من الحجزِ تُمَسُّ ولا تُدَّعى مِلكًا: ACTIVE_WORK.md · DISCOVERIES.md · COMPLETION_LEDGER.md · docs/audit/TRUTH_MATRIX.md وdocs/audit/truth_matrix.json المولَّدتانِ بالأداةِ | 2026-08-31 | 2026-09-07 | — | قراءةُ حكمِ CI على عقدةِ التنفيذِ رقمًا، ثمَّ تسليمُ البندِ للمراجعةِ (`W-078`) — ولا `VERIFIED` إلّا بيدِ المالكِ | W-077 · الحرسُ وفحوصُه وأربعُ بوّاباتٍ مربوطةٍ في CI · وحكمُ عقدةِ `W-076` مقروءٌ رقمًا |
...
بدأ: 2026-08-31        ينتهي الحجز: 2026-09-07
العائق: —
الخطوةُ التالية: قراءةُ حكمِ CI على عقدةِ التنفيذِ رقمًا ثمَّ التسليمُ للمراجعةِ (`W-078`)
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
  ...
  - **و`VERIFIED` — متى وُضِعَت — ليست شهادةَ عينٍ ثانيةٍ**: المراجعُ هو المالكُ جامعًا الدورَينِ بنصِّ `A-2` (`DISC-027` · `RK-020`)
قيدُ السجلّ: W-077 · الحرسُ وفحوصُه (17) وربطُ أربعِ بوّاباتٍ في CI · وحكمُ عقدةِ `W-076` قُرِئَ رقمًا
```
