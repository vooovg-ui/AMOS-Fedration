...
# الهدف · Purpose: فحص سجل الأدوات — قياسٌ حيٌّ لعدد الأدوات المسجَّلة
# طريقُ الإنفاذ: NEEDS_LIVE_DB — يقرأُ عدّاداتٍ حيّةً عبرَ `tools.audit.live_truth` فيلزمُه رابطُ قاعدةٍ لا تملكُه دفعةٌ
