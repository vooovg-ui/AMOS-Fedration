...
قيدُ السجلّ: W-079 · الحجزُ وقياسُ خطِّ الأساسِ (13 أداةً بلا خطوةِ تشغيلٍ · منها ما لا مدخلَ له أصلًا)
```
