...
طريقُ الإنفاذ: REPORT_NO_VERDICT — يطبعُ قياسًا ولا يحكُمُ برمزٍ إلّا على خطأِ استعمالٍ (قِيسَ: 3.34ث · رمزُ 0)
"""
...
DEFAULT_OUT = ROOT / "docs/audit/measurements/judicial_gate_matrix.json"
