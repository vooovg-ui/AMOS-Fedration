...
## تاريخ آخر تعديل: 2026-08-29 (`WI-017` — «الحرسُ مُجرَّبٌ بطفرةٍ» خرجَ من النثرِ إلى أمرٍ يُعادُ: خمسةَ عشرَ عَطبًا تُعادُ في نسخةٍ معزولةٍ وتُقاسُ الفحوصُ الساقطةُ)
