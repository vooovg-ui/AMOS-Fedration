...
def test_كلُّ_التزامٍ_مرئيٍّ_إزاحتُه_عالميّةٌ(measured):
    """`non_utc` صفرٌ في المُعلَنِ، فأوّلُ التزامٍ بإزاحةٍ محلّيّةٍ يُسقِطُ الفحصَ."""
    assert measured["non_utc"] == 0, (
        f"وُجِدَ {measured['non_utc']} التزامًا إزاحتُه ليست `+00:00` — "
        "الاتّفاقُ صارَ إنفاذًا في هذا الحقلِ (‏§ 10 حدًّا 8)"
    )
