...
| WI-046 | tooling-gates | T0 (‏قابليّةُ القياسِ · `DISC-054`: أثرٌ مُولَّدٌ يشهدُ في متنِه أنَّ قياسَه جرى في بيئةٍ **ناقصةٍ** ولا يقرأُ تلكَ الشهادةَ حرسٌ — فوثيقةٌ معطوبةٌ تمرُّ بكلِّ بوّابةٍ برمزِ خروجٍ 0 · والمقيسُ **وثيقتانِ شاهدتانِ · صفرُ مُعلِنٍ نقصًا · صفرُ قارئٍ** · **استحقاق 2026-09-12**) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tools/governance/artifact_witness_integrity.py · tests/governance/test_w131_artifact_witness_integrity.py | 2026-09-03 | 2026-09-12 | لا عائقَ — المسارانِ **جديدانِ غيرُ مُدَّعيَينِ** فلا `CLAIM_COLLISION` (§ 6.2)، والوثيقتانِ المقروءتانِ **لا تُمَسّانِ** (‏قراءةٌ لا كتابةٌ) | إنزالُ الحرسِ وفحوصِه، ثمَّ قراءةُ حكمِ CI برقمِ تشغيلٍ وقيدُه قبلَ النقلِ إلى `IN_REVIEW` (§ 4.3) | — |
...
المالك: Driving H            المراجع: المالك (`A-2` · غيرُ مستقلٍّ)
الحالة: IN_PROGRESS   (‏`PROPOSED` ← `READY` ← `RESERVED` ← `IN_PROGRESS` بلا قفزٍ · § 4.3)
