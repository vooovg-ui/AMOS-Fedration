...
| WI-038 | tooling-gates | T0 (‏قابليّةُ القياسِ · `DISC-046`: «الحالةُ المقيسةُ الآن» تُعلِنُ حجمَ حزمةٍ متقادمًا — المكتوبُ 1748 والمقيسُ 2351 — ولا بوّابةَ تقرأُ رقمًا في نثرٍ · **استحقاق 2026-09-10**) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tools/governance/suite_size_inventory.py · tests/governance/test_w120_suite_size_claims.py | 2026-09-03 | 2026-09-10 | — | قراءةُ حكمِ CI لعقدةِ `W-121` ثمَّ التسليمُ للمراجعةِ | — |
...
العائق: —
الخطوةُ التالية: قراءةُ حكمِ CI لعقدةِ `W-121` برقمِ تشغيلٍ، ثمَّ نقلُ البندِ إلى `IN_REVIEW` بلا `VERIFIED` (§ 4.3)
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
...
قيدُ السجلّ: W-120 (‏الحجزُ) · W-121 (‏نزولُ الأداةِ والحرسِ وتصحيحُ الرقمِ: 13 فحصًا · 4 مواضعَ صُحِّحَت · حزمةُ الخدماتِ مُعلَنةٌ «غيرُ مقيسةٍ» في وظيفةِ بوّاباتِ الحوكمةِ بسببٍ مكتوبٍ) · و**خليّةُ «قيدُ السجلّ» في صفِّ § 1 تُكتَبُ `—`** بالسابقةِ المقيسةِ (`DISC-010` · `DISC-030`)
```
