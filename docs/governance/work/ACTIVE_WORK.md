...
| WI-031 | tooling-gates | T0 (قابليّةُ القياسِ · جذرُ القياسِ مُثبَّتٌ بعُمقٍ مكتوبٍ فيُقرأُ أخضرُ عن شجرةٍ غيرِ مقصودةٍ · `DISC-041` · سببُ `DISC-032` الأعمقُ) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | RESERVED | tests/governance/test_w102_measurement_root_provenance.py | 2026-09-02 | 2026-09-09 | — | كتابةُ الحرسِ القارئِ وإعلانُ الرقمَينِ سقّاطةً، ثمَّ إعادةُ القياسِ ودفعُه مع قيدِه | — |
...
الحالة: RESERVED
المسارات:
  tests/governance/test_w102_measurement_root_provenance.py        (‏جديدٌ — قارئٌ تركيبيٌّ يُحصي النمطَ ويُعلِنُ رقمَينِ لا يعلوانِ)
...
العائق: —
الخطوةُ التالية: كتابةُ الحرسِ وإعلانُ الرقمَينِ ثمَّ إعادةُ القياسِ ودفعُه مع قيدِه
