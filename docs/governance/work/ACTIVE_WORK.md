...
| WI-028 | tooling-gates | T0 (قابليّةُ القياسِ · حرسٌ يقرأُ الدعوى بجذرِ كلمةٍ فيُحمِّرُ على قيدٍ صادقٍ) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tools/governance/mutation_claims.py · tests/governance/test_w063_registered_claims.py | 2026-09-01 | 2026-09-08 | — | كتابةُ الإعلانِ الصريحِ وسجلِّ الصفوفِ التاريخيّةِ المُجمَّدِ ثمَّ أوجهُ الحرسِ | W-092 |
...
بدأ: 2026-09-01        ينتهي الحجز: 2026-09-08
العائق: —
الخطوةُ التالية: كتابةُ الإعلانِ الصريحِ والسجلِّ المُجمَّدِ وأوجهِ الحرسِ، ثمَّ قياسٌ ودفعٌ وقراءةُ حكمٍ برقمِ تشغيلٍ
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
...
قيدُ السجلّ: W-092 · الحجزُ وفحصُ التداخلِ
```
