...
## تاريخ آخر تعديل: 2026-09-01 (`WI-029` — «الفحصُ يقرأُ الشجرةَ التي يُعلِنُها» يُحصى بحرسٍ لا بعينٍ: خطُّ الأساسِ 24 تشغيلًا · 5 تقصِدُ شجرةً مؤقَّتةً · **1 يحكُمُ على شجرةٍ لا يقرؤها**) · وقبلَه 2026-08-30 (`WI-021` — ماسحٌ واحدٌ مرجعيٌّ لبوّابةِ 6، ومحلُّ قياسٍ صريحٌ، وحالةٌ لا تُكتَبُ مرّتَينِ متناقضتَينِ) · وقبلَه 2026-08-29 (`WI-019` — الحكمُ الأحمرُ صارَ مقروءًا ثمَّ صارَ أخضرَ: سببُه سطرُ اختبارٍ لا حرسٌ ضعيفٌ، فأُصلِحَ الفتيلُ ولم يُخفَّفِ الماسحُ)
...
| WI-029 | tests-root | T0 (قابليّةُ القياسِ · فحصٌ يُشغِّلُ أداةً في عمليّةٍ فرعيّةٍ ويحكُمُ على شجرةٍ **لا يقرؤها** · `DISC-032`) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | RESERVED | tests/governance/test_w096_subprocess_measurement_site.py · tests/governance/test_w054_post_merge_reverse_link.py | 2026-09-01 | 2026-09-08 | — | كتابةُ الحرسِ وإصلاحُ الموضعِ المقيسِ ثمَّ إعادةُ القياسِ | — |
...
بدأ: 2026-09-01        ينتهي الحجز: 2026-09-08
العائق: —
الخطوةُ التالية: كتابةُ الحرسِ وإصلاحُ الموضعِ المقيسِ ثمَّ إعادةُ القياسِ ودفعُه مع قيدِه
حكمُ CI المقروءُ: — (‏لم يُدفَعْ بعدُ · عقدةُ الحجزِ هذه تُقرأُ في القيدِ التالي)
