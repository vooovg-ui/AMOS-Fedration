...
| WI-031 | tooling-gates | T0 (قابليّةُ القياسِ · جذرُ القياسِ مُثبَّتٌ بعُمقٍ مكتوبٍ فيُقرأُ أخضرُ عن شجرةٍ غيرِ مقصودةٍ · `DISC-041` · سببُ `DISC-032` الأعمقُ) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tests/governance/test_w102_measurement_root_provenance.py | 2026-09-02 | 2026-09-09 | — | قراءةُ حكمِ CI لعقدةِ النزولِ ثمَّ `IN_REVIEW` (§ 4.3) | — |
...
المالك: Driving H            المراجع: المالك (`A-2` · غيرُ مستقلٍّ)
الحالة: IN_PROGRESS   (‏RESERVED في `W-102` ← IN_PROGRESS في `W-103` · ولا يُقفَزُ إلى `IN_REVIEW` قبلَ حكمٍ مقروءٍ · § 4.3)
المسارات:
...
العائق: —
الخطوةُ التالية: قراءةُ حكمِ CI لعقدةِ نزولِ الحرسِ برقمِ تشغيلٍ، ثمَّ `IN_REVIEW` — ثمَّ مراجعةُ المالكِ (‏`A-2` `PENDING` · المراجعُ غيرُ مستقلٍّ: `DISC-027` · `RK-020`)
حكمُ CI المقروءُ: عقدةُ الحجزِ `9d460b5` وعقدةُ النزولِ تُقرآنِ بأرقامِ تشغيلٍ في `W-103` وما يليه — ولا يُقرأُ الأخضرُ إغلاقًا
