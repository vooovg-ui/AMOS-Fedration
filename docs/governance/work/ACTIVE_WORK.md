...
| WI-037 | tooling-gates | T0 (‏قابليّةُ القياسِ · `DISC-042`: خليّةُ المساراتِ تُشطَرُ على «·» فيُقرأُ الجزءُ النثريُّ دعوى، ونثرٌ يذكرُ مجلَّدًا يُغطّيه كلَّه · **استحقاق 2026-09-09**) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tools/governance/check_work_governance.py · tests/governance/test_w117_claim_cell_shape.py | 2026-09-03 | 2026-09-10 | — | قراءةُ حكمِ CI لعقدةِ الحرسِ ثمَّ `IN_REVIEW` (§ 4.3 — ولا يضعُ الكاتبُ `VERIFIED`) | — |
...
العائق: —
الخطوةُ التالية: قراءةُ حكمِ CI لعقدةِ الحرسِ ثمَّ `IN_REVIEW`
حكمُ CI المقروءُ (‏الأحدثُ): — (‏لا عقدةَ لهذا البندِ بعدُ · ولا يُدَّعى حكمٌ لم يُقرَأْ)
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
