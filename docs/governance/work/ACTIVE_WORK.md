...
| WI-038 | tooling-gates | T0 (‏قابليّةُ القياسِ · `DISC-046`: «الحالةُ المقيسةُ الآن» تُعلِنُ حجمَ حزمةٍ متقادمًا — المكتوبُ 1748 والمقيسُ 2351 — ولا بوّابةَ تقرأُ رقمًا في نثرٍ · **استحقاق 2026-09-10**) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tools/governance/suite_size_inventory.py · tests/governance/test_w120_suite_size_claims.py | 2026-09-03 | 2026-09-10 | — | قراءةُ حكمِ CI لعقدةِ `W-122` ثمَّ التسليمُ للمراجعةِ | — |
...
العائق: —
الخطوةُ التالية: قراءةُ حكمِ CI لعقدةِ `W-122` برقمِ تشغيلٍ، ثمَّ نقلُ البندِ إلى `IN_REVIEW` بلا `VERIFIED` (§ 4.3)
حدُّ البندِ — مُعلَنٌ لا مطويٌّ:
