...
| WI-043 | tooling-gates | T0 (‏قابليّةُ القياسِ · `DISC-051`: الفحصُ الذي يُثبِتُ استقرارَ الأثرِ المُولَّدِ يُسمّي ثلاثةَ مُولِّداتٍ نصًّا، فمُولِّدٌ جديدٌ لا يدخُلُ الحرسَ **ولا يُبلَّغُ عن غيابِه** — والمقيسُ 11 مُولِّدًا و4 مربوطةٌ فقط · **استحقاق 2026-09-11**) | Driving H | المالك (`A-2` · غيرُ مستقلٍّ) | IN_PROGRESS | tools/governance/generator_settlement_closure.py · tests/governance/test_w129_generator_settlement_closure.py | 2026-09-03 | 2026-09-11 | لا عائقَ — المسارانِ **جديدانِ غيرُ مُدَّعيَينِ** فلا `CLAIM_CONFLICT` · والسبعةُ غيرُ المربوطةِ لا تُربَطُ في هذا البندِ: المُنجَزُ منعُ نموِّها | قراءةُ حكمِ CI على عقدةِ الدفعِ ثمَّ النقلُ إلى `IN_REVIEW` بلا `VERIFIED` (§ 4.3) | — |
