...
## تاريخ آخر تعديل
2026-08-22 (W-030 — خارطةُ الطريقِ المُعلَنةُ لمن يأتي بعدُ تُضاف)
...
### 6) التاليّ بالترتيبِ الذي نصَّ عليه الحسمُ

**`W-034` = Q-40 (ج):** ترويسةُ هويّةٍ في كلِّ ملفِّ حالةِ تشغيلٍ مولَّدٍ + `README`
معَ المجلَّدِ. وبه يُغلَقُ آخرُ ما فُتِحَ بحسمِ 2026-08-23.
